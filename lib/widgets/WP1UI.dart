...
import 'package:skido/widgets/pay_sponsor_button.dart';
import 'package:skido/widgets/working_proffessional_header.dart';

import 'CV_button.dart';
import 'grid.dart';


class WP1UI extends StatefulWidget {
  const WP1UI({Key? key}) : super(key: key);

  @override
  State<WP1UI> createState() => _WP1UIState();
}

class _WP1UIState extends State<WP1UI> {
  @override
        ...
        children: [
          ...
          Positioned(
              ...
              child: Row(
                ...
                children: [
                  PaySponsorButton(isPay:true),
                  PaySponsorButton(isPay:false),
                ],
              )
          ),
          Positioned(
