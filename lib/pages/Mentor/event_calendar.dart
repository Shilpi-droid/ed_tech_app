...
import '../../widgets/Mentor/event_widget.dart';
  ...
  Widget build(BuildContext context) {
    return  Column(
          children: [
           ...
           // EventWidget(topic: 'Product Management',subtopic: 'Marketing',timing: '8:30 - 9:30')
            Expanded(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: EventWidget(topic: value[index].title, subtopic: value[index].subtitle, timing: value[index].time),
                      );
                      //   Container(
